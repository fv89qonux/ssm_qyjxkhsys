...
<jsp:include page="../common/hotelHeader.jsp">
    ...
    <jsp:param name="menuName" value="loginLogList"></jsp:param>
</jsp:include>
                ...
                <div class="row">
                    ...
                    <form id="searchForm" class="form-horizontal form-query clearfix col-sm-12" onsubmit="return false">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="key" placeholder="姓名、用户名">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="table-responsive">
                            <table id="loginLogGrid" class="datagrid" data-options="{url : '/ssm_qyjxkhsys/info/loginLog/findLoginLogs'}">
                                <thead>
                                <tr>
                                    <th field="id" number="true" align="center" width="50"></th>
                                    <th field="userName">姓名</th>
                                    <th field="userAccount">用户名</th>
                                    <th field="loginTime" format="fmtTime">登录时间</th>
                                    <th field="ip">登录IP</th>
                                </tr>
                                </thead>
                            </table>
...
<script type="text/javascript" src="/ssm_qyjxkhsys/custom/js/loginLog.js"></script>
