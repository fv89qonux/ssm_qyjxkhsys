...
$.validator.addMethod("phoneCN", function(phone_number, element) {
	phone_number = phone_number.replace(/\(|\)|\s+|-/g, "");
	return this.optional(element) || phone_number.length > 9 &&
		phone_number.match(/^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/);
}, "请输入合法的手机号码");

$.validator.addMethod("confirm", function(value, element,param) {
	value = value.replace(/\(|\)|\s+|-/g, "");
	var confirmValue = $(param).val().replace(/\(|\)|\s+|-/g, "");
	return this.optional(element) || value == confirmValue;
}, "两次输入不相符");
