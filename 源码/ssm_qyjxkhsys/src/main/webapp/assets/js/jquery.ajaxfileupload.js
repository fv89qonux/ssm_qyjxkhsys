jQuery.extend({
    ...
    createUploadForm: function(id,fileElementId,data,fileElement)
	{
		...
		if(Object.prototype.toString.call(fileElementId) === '[object Array]'){
			jQuery.each(fileElementId,function(i,id){
    ...
    ajaxFileUpload: function(s) {
		...
		var _wait = $("<div style='z-index:99999;height:100%;width:100%;cursor:wait;position: fixed;left: 0;top:0;display: none;'></div>");
